...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div class="row justify-content-center"><div class="col-12 col-xl-9">
            ...
            <div class="row mb-3 align-items-center"><asp:Label runat="server" AssociatedControlID="txtIp" CssClass="col-md-3 fw-bold text-modbus" Text="IP adresi" /><div class="col-md-9"><asp:TextBox ID="txtIp" runat="server" CssClass="form-control form-control-modbus" MaxLength="15"></asp:TextBox></div></div>
            <div class="row mb-3 align-items-center"><asp:Label runat="server" AssociatedControlID="txtHttpPort" CssClass="col-md-3 fw-bold text-modbus" Text="HTTP portu" /><div class="col-md-9"><asp:TextBox ID="txtHttpPort" runat="server" CssClass="form-control form-control-modbus" MaxLength="5"></asp:TextBox></div></div>
            ...
            <div class="d-flex gap-2 mb-4"><asp:Button ID="btnKaydet" runat="server" Text="Kaydet" CssClass="btn btn-success" OnClick="btnKaydet_Click" />
                <a href="EthernetKartListele.aspx" class="btn btn-secondary">Listeye dön</a></div>
        </div></div>
    </div>
</asp:Content>
